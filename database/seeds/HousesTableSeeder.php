...
class HousesTableSeeder extends Seeder
{
    ...
    public function run(Faker $faker)
    {
        for($i = 0; $i < 100; $i++){
            ...
            $new_house->square_meters = $faker->numberBetween(10,500);
            ...
            $new_house->descriptions = $faker->text(100);
            $new_house->price = $faker->numberBetween(10000,1000000000);
            $new_house->descriptions = $faker->numberBetween(0,1);
            $new_house->save();
        }
    }
}
